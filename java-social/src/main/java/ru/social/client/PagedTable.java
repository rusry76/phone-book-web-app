...
public class PagedTable extends Table {
    ...
    public HorizontalLayout createControls() {
        final Label itemsPerPageLabel = new Label("Результатов на страницу:");
        ...
        itemsPerPageSelect.addValueChangeListener(valueChangeEvent -> {
            setPageLength(Integer.valueOf(String.valueOf(valueChangeEvent.getProperty().getValue())));
        });


        final Label pageLabel = new Label("Страница:&nbsp;", ContentMode.HTML);
        final TextField currentPageTextField = new TextField();
        currentPageTextField.setValue(String.valueOf(getCurrentPage()));
        currentPageTextField.setConverter(Integer.class);
        //currentPageTextField.addValidator(new IntegerRangeValidator("Неверные символы!", 1, getTotalAmountOfPages()));
        ...
        first.addClickListener(clickEvent -> {
            setCurrentPage(0);
        });
        ...
        last.addClickListener(clickEvent -> {
